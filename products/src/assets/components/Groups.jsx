...
const initialChannelData = [
  {
    ...
    items: [
      { name: 'Cravings✔', followers: '9.5M', image: '/images/cravings.jpeg', isFollowing: false },
      { name: 'News18 India✔', followers: '17.1M', image: '/images/News18India.jpeg', isFollowing: false },
      { name: 'Hindi Behind Talkies✔', followers: '4.4M', image: '/images/behindtalks.png', isFollowing: false },
      { name: 'Total Gaming✔', followers: '13.3M', image: '/images/gaming.png', isFollowing: false },
    ],
  },
  {
    category: 'Entertainment',
    items: [
      { name: 'Koimoi✔', followers: '1.3M', image: '/images/koimoi.png', isFollowing: false },
      { name: 'ABP News✔', followers: '15.7M', image: '/images/abd.png', isFollowing: false },
      { name: 'Behind Talkies✔', followers: '4.3M', image: '/images/talks.png', isFollowing: false },
      { name: 'TV9 Telugu✔', followers: '6.9M', image: '/images/tv9.jpg', isFollowing: false },
    ],
  },
  {
    category: 'Sports',
